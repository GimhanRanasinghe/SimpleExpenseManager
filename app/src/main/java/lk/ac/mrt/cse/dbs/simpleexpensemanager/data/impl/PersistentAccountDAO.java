...
public class PersistentAccountDAO implements AccountDAO {
    ...
    public List<Account> getAccountsList() {
        return new ArrayList<>(sqLiteHelper.getAccountsList());
    }

    @Override
    public Account getAccount(String accountNo) throws InvalidAccountException {
        if (sqLiteHelper.isValidAccount(accountNo)) {
            return sqLiteHelper.getAccount(accountNo);
        }
        String msg = "Entered account number is invalid";
    ...
    public void updateBalance(String accountNo, ExpenseType expenseType, double amount) throws InvalidAccountException {
        ...
        sqLiteHelper.updateBalance(account);
    }
}
